import numpy as np
from meta_rand_envs.ant_multi_env import AntMultiEnv
from gym import utils

from . import register_env


@register_env('ant-multi-task')
class AntMultiTaskWrappedEnv(AntMultiEnv):
    def __init__(self, *args, **kwargs):
        super(AntMultiTaskWrappedEnv, self).__init__(*args, **kwargs)
        self.train_tasks, self.test_tasks = self.sample_tasks([kwargs.get('n_train_tasks', 90), kwargs.get('n_eval_tasks', 45)])
